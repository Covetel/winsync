...
rem ======== Build ========
rem   ------ Set Build Paths ------
set INCLUDE=%INCLUDE%;%LIBROOT%\ldapsdk\public\ldap;%LIBROOT%\nspr\include;%LIBROOT%\nss\include;C:\mozilla\directory\c-sdk\ldap\include;C:\mozilla\nsprpub;C:\mozilla\security\nss;C:\mozilla\dist\public\ldap;C:\mozilla\dist\public\nss;C:\mozilla\dist\WINNT5.2_OPT.OBJ\include
set LIB=%LIB%;%LIBROOT%\ldapsdk\lib;%LIBROOT%\nspr\lib;%LIBROOT%\nss\lib;C:\mozilla\dist\WINNT5.2_OPT.OBJ\lib;C:\mozilla\dist\lib;C:\mozilla\nsprpub\WINNT5.2_OPT.OBJ\lib
